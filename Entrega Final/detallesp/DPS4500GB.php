...
<html lang="es">
    ...
    <body onload="cambiarp(0,1,2,'black','white','','')">
        <div id="ci" style="display: none">PS4500GB/</div>
        <div class="cuerpo" onclick="oc('droplist')">
            <div class="cu_cabecera">
                ...
                <div class="imagen">
                    <div class="ip">
                        <div class="img" style="background-image: url('img/PS4500GB/foto1-1.jpg')"><button class="bt" onclick="cambiarp(0,1,2,'black','white','','')"></button></div>
                        <div class="img" style="background-image: url('img/PS4500GB/foto2-1.jpg')"><button class="bt" onclick="cambiarp(0,2,0,'','','','')"></button></div>
                        <div class="img" style="background-image: url('img/PS4500GB/foto3-1.jpg')"><button class="bt" onclick="cambiarp(0,3,0,'','','','')"></button></div>
                        <div class="img" style="background-image: url('img/PS4500GB/foto4-1.jpg')"><button class="bt" onclick="cambiarp(0,4,0,'','','','')"></button></div>
                    </div>
                    <div class="ig">
                ...
                <div class="precio">
                    ...
                    <div class="comprar">
                        <form action="../add_product.php" method="get">
                            <button type="sumbit" name="id" value="8" style="width: 100%; background-color: #a18951;"><div class="imgcomprar"></div><h3>Comprar</h3></button>
                        </form>
                    </div>
                </div>
            </div>
