...
<html lang="es">
    ...
    <body onload="cambiarp(0,1,2,'black','white','','')">
        <div id="ci" style="display: none">PS41TB/</div>
        <div class="cuerpo" onclick="oc('droplist')">
            <div class="cu_cabecera">
                <div class="nombre">
                    <h1>Sony PlayStation 4 1TB</h1>
                </div>
                <div class="imagen">
                    <div class="ip">
                        <div class="img" style="background-image: url('img/PS41TB/foto1-1.jpg')"><button class="bt" onclick="cambiarp(0,1,2,'black','white','','')"></button></div>
                        <div class="img" style="background-image: url('img/PS41TB/foto2-1.jpg')"><button class="bt" onclick="cambiarp(0,2,0,'','','','')"></button></div>
                        <div class="img" style="background-image: url('img/PS41TB/foto3-1.jpg')"><button class="bt" onclick="cambiarp(0,3,0,'','','','')"></button></div>
                        <div class="img" style="background-image: url('img/PS41TB/foto4-1.jpg')"><button class="bt" onclick="cambiarp(0,4,0,'','','','')"></button></div>
                    </div>
                    <div class="ig">
                ...
                <div class="precio">
                    ...
                    <div class="comprar">
                        <form action="../add_product.php" method="get">
                            <button type="sumbit" name="id" value="1" style="width: 100%; background-color: #a18951;"><div class="imgcomprar"></div><h3>Comprar</h3></button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="cu_info">
                <div class="cu_espec cu_in">
                    ...
                    <ul>
                        <li>Playstation 4</li>
                        <li>Mando inalámbrico DUALSHOCK 4</li>
...
Emitir  tus partidas de PS4 en tus juegos favoritos es fácil y puedes hacerlo  directamente en streaming en Twitch o Youtube, echar una mano a tus colegas a pasarse un jefe final podrás hacerlo incluso sin tener el juego. Todo eso y mucho más en tu PlayStation 4 al precio más competente. <br><br></p>
                </div>
