...
<html lang="es">
    ...
    <body onload="cambiarp(0,1,4,'black','blue','grey','white')">
        <div id="ci" style="display: none">XBOXONE1TBEC/</div>
        <div class="cuerpo" onclick="oc('droplist')">
            <div class="cu_cabecera">
                <div class="nombre">
                    <h1>XBOX ONE + ELITE CONTROLLER</h1>
                </div>
                <div class="imagen">
                    <div class="ip">
                        <div class="img" style="background-image: url('img/XBOXONE1TBEC/foto1-1.jpg')"><button class="bt" onclick="cambiarp(0,1,4,'black','blue','grey','white')"></button></div>
                        <div class="img" style="background-image: url('img/XBOXONE1TBEC/foto2-1.jpg')"><button class="bt" onclick="cambiarp(0,2,0,'','','','')"></button></div>
                        <div class="img" style="background-image: url('img/XBOXONE1TBEC/foto3-1.jpg')"><button class="bt" onclick="cambiarp(0,3,0,'','','','')"></button></div>
                        <div class="img" style="background-image: url('img/XBOXONE1TBEC/foto4-1.jpg')"><button class="bt" onclick="cambiarp(0,4,0,'','','','')"></button></div>
                    </div>
                    <div class="ig">
                ...
                <div class="precio">
                    ...
                    <div class="comprar">
                        <form action="../add_product.php" method="get">
                            <button type="sumbit" name="id" value="12" style="width: 100%; background-color: #a18951;"><div class="imgcomprar"></div><h3>Comprar</h3></button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="cu_info">
                <div class="cu_espec cu_in">
                    ...
                    <h3>Mando Elite Controller:</h3>
                    <ul>
                        <li>Preparado para su uso con sistemas Xbox One y PC que ejecuten Windows 7 o posterior. Para usar un PC se requiere el cable USB que se incluye o un adaptador inalámbrico.</li>
                        <li>Incluye 4 levas traseras configurables</li>
                        <li>Incluye un Trackpad más sensible y Joysticks más rápidos</li>
                        <li>Diseño gaming mejorado</li>
                        <li>Incluye conector para auriculares estéreo de 3,5 mm. Compatible también con el adaptador para auriculares estéreo de Xbox One y el resto de accesorios Xbox One originales.</li>
                    </ul>
                    <h3>La caja incluye:</h3>
                    <ul>
                        <li>XBOX ONE 1TB</li>
                        <li>Mando inalambrico de XBOX ONE ELITE CONTROLLER</li>
...
Accede anticipadamente a todos los juegos de EA antes de su lanzamiento para el resto de plataformas gracias al EA Access. Disfruta de juegazos como Fallout 4 y los mejores exclusivos: Halo 5: Guardians, Gears of War: Ultimate Edition, o Rise of the Tomb Raider, por mencionar algunos. Comparte tu tiempo de juego con amigos a través de Xbox Live y dale una segunda vida a tus juegos de la consola Xbox 360 en Xbox One. Ponte al día comprando tu Xbox One al mejor precio y sigue disfrutando de tus juegos favoritos de la generación anterior. ¡Mata dos pájaros de un tiro!. <br><br>
El diseño ergonómico del pad de Xbox One –Xbox One Wireless Controller– le convierte en la herramienta definitiva con la que pulverizar todos tus records. Desbloquea logros sin parar disfrutando de la salvaje acción que te proporcionan los gatillos de impulso, los joysticks interactivos estratégicamente colocados. <br><br></p>
                </div>
